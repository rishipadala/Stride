export type AttendanceStatus = "PRESENT" | "HALF_DAY" | "WFH" | "LEAVE" | "HOLIDAY";
...
export function statusDotClass(status: AttendanceStatus | WorkLogStatus | null): string {
  const map: Record<string, string> = {
    ...
    LEAVE: "dot-leave", HOLIDAY: "dot-holiday",
...
export function statusLabel(status: string): string {
  const labels: Record<string, string> = {
    PRESENT: "Present", HALF_DAY: "Half Day", WFH: "WFH", LEAVE: "Leave", HOLIDAY: "Holiday",
